...
public interface Invocation extends Remote{
	 ...
	 * 
	 * @param filePath relative path of the file to backup
	 * @param desiredRepDeg desired degree of replication for the files chunks
	 ...
	 * 
	 * @param filePath path of the file we want to restore. Must be the same path as of when the file
	 * was backed up
	 * 
	 * @return String indicating that the protocol has finished
	 * @throws RemoteException
	 ...
	 * 
	 * @param filePath relative path of the file we want to delete. Must be same path as of when the file
	 * was backed up
	 * 
	 * @return String indicating that the protocol has finished
	 * @throws RemoteException
	 ...
	 * 
	 * @param reclaimSpace total space to try to reclaim for the Peer
	 * @return String indicating that the protocol has finished
	 * @throws RemoteException
	 */
